...
* The game's a bit boring as it is. Add a new feature to the game to make it more enjoyable. Some ideas are:
  ...
  * Add a score. How will you know that you're the best Ceros Tests if there's no score? Maybe store that score
...
* Tests should get faster as the game progresses
